...
function Desc() {
  return (
    <div className='h-[500px] sm:h-[500px] md:h-[400px] flex flex-col items-center justify-start text-center my-10 px-4 max-w-7xl mx-auto'>
          ...
          <div className='flex my-10 items-center justify-center py-auto lg:space-x-8 space-x-2 text-gray-500'>
              <div className='lg:!text-[30px] capitalize'>License: <span className='uppercase'>mit</span></div>
              <div><Button link={"github"} className="px-[10px] py-[10px] bg-transparent shadow-none sm:text:[22px] text-[17px] text-blue-500 lg:!text-[30px] sm:text:[22px]   hover:bg-blue-100 hover:shadow-none">GitHub</Button></div>
          </div>
    </div>
  );
}
