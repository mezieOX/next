...
function Desc() {
  return (
    <div className='h-[500px] sm:h-[500px] md:h-[400px] flex flex-col items-center justify-start text-center my-10 px-4 max-w-7xl mx-auto'>
          <h2 className='text-black font-bold text-[40px] md:text-[58px] lg:text-[80px] xl:text-[100px] 2xl:text-[120px] max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-7xl 2xl:max-w-9xl leading-[50px] sm:leading-[80px] md:leading-[90px] lg:leading-[100px] xl:leading-tight sm:-mt-[60px]'>The React Framework for Production</h2>
